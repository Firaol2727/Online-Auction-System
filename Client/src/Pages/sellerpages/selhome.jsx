            ...
            <SellerNavbar/>
                <Box sx={{
                    ...
                    <h2>Overview</h2>
                    {
                        ...
                        <Link to={`/sel/detail/${auction.id}`} key={auction.id} underline="none">    
                            <Box
                                sx={{
                                borderRadius: "30px",
                    ...
                    <Box
                        ...
                        <Link to={`http://localhost:5173/sel/detail/dfgasdf`} underline="none">
